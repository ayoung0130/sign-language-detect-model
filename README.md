...
## 전체 시스템 구조
<img src="architecture_image/system_architecture.png" alt="system_architecture" width="600"/>
...
## 활용한 랜드마크
<img src="architecture_image/MediaPipe_landmarks.png" alt="MediaPipe_landmarks" width="600"/>


## 학습 데이터 구조
<img src="architecture_image/data_structure.png" alt="data_structure" width="600"/>
...
## 단어 예측 알고리즘
<img src="architecture_image/model_predict_words.png" alt="model_predict_words" width="600"/>
- 사용자가 수어 동작을 시작할 때부터 손을 내린 순간까지의 시퀀스 데이터 생성
- 다수결 투표 방식으로 단어 예측


## 문장 생성 알고리즘
<img src="architecture_image/model_predict_sentence.png" alt="model_predict_sentence" width="600"/>
...
## 40개 단어 학습 모델 혼동 행렬
<img src="architecture_image/confusion_matrix_40words.png" alt="confusion_matrix_40words" width="600"/>
