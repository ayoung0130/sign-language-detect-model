...
def shift_data():
    ...
    for idx in range(1, 10):
        ...
        folder_path = os.path.join(base_dir, f'npy/landmarks_angle/{idx}')
        save_path = os.path.join(base_dir, f'npy_shift/landmarks_angle/{idx}')
        ...
        for npy_file in os.listdir(folder_path):
            ...
            for scale in scales:
                ...
                if "1_" in base_name:
                    print(f"{base_name} {scale} shift 전: ", data[1, 0:4])
                ...
                if "1_" in base_name:
                    print(f"{base_name} {scale} shift 후: ", data[1, 0:4])
                    print("")
