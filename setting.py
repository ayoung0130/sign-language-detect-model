...
# 학습할 수어 단어
actions = ['가렵다', '기절', '부러지다', '어제', '어지러움', '열나다', '오늘', '진통제', '창백하다', '토하다', '배', '다리', '어깨', '눈', '코', '목', '머리', '발',
           '너무 아파요', '위', '음식물', '깔리다', '인대', '뼈', '알려주세요', '내일', '피나다', '손', '월요일', '화요일', '수요일', '목요일', '금요일', '토요일', '일요일'
           '등', '무릎', '병원', '얼굴', '의사', '귀', '두드러기생기다', '떨어지다', '복통', '호흡곤란', '화상', '아래', '오른쪽', '왼쪽', '끝']
